...
import com.android.contacts.other.AccountsTestHelper;
import com.android.contacts.other.FakeSimContactDao;
...
//        mAccountHelper.cleanup();
    ...
    public static void tearDownClass() {
        AccountsTestHelper.removeAccountsWithPrefix(
                ApplicationProvider.getApplicationContext(), "SimImportActivity");
    }
    ...
    @Test
    public void smokeRotateInNonEmptyState() {
...
//                .withDefaultProjection(SimContactDaoImpl._ID, SimContactDaoImpl.NAME,
...
//
//        SimContactDao.setFactoryForTest(input -> {
...
//                mContext.getContentResolver().query(ContactsContract.Data.CONTENT_URI, null,
...
//            assert contactsProviderClient != null;
